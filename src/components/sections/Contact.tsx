...
export function Contact() {
  ...
  const contactInfo = useMemo(() => [
    { icon: Mail, label: 'Email', value: config?.email || 'hello@beit.solutions' },
    { icon: Phone, label: 'Phone', value: config?.phone || '+32 400 000 000' },
    { icon: MapPin, label: 'Location', value: config?.address || 'Rue de la Loi, Brussels' }
  ], [config]);
