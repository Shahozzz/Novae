...
import { MousePointer2, ChevronRight, Zap, Shield, Cpu, Monitor } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div className="text-center lg:text-left space-y-8 animate-reveal">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            <Button size="lg" className="h-14 px-8 text-lg font-bold group shadow-glow" onClick={() => login()}>
              {t.hero.cta}
